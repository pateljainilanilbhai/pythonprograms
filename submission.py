...
#         self.logged_in = False
#
# q=Sms("7984629771","P2635C")
# for i in range(1):
#     q.send("7984629771",str(i))
# q.logout()
...
# get response
response = sendPostRequest(URL, '67T0BIPI2LPFPP71B7YB23FU5T0BZTFY', 'K50YWZUIR4RWTNMD', 'stage', '7984629771', 'active-sender-id', 'HELLO' )
"""
  Note:-
